...
func TestValidateContext(t *testing.T) {
	tests := []struct {
		...
		{name: "foreign name", context: "kind-demo", nodes: []Node{{Name: "other-worker", ProviderID: "kind://docker/demo/other-worker"}}, wantErr: true},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := ValidateContext(tt.context, tt.nodes)
